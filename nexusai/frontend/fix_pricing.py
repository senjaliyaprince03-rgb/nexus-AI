...
with open(r'c:\Users\Prince\Downloads\NexusAi\nexusai\frontend\src\components\pricing\PricingSection.tsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
end_idx = content.rfind(']', start_idx, helpers_idx) + 1

content = content[:start_idx] + new_plans + content[end_idx:]

with open(r'c:\Users\Prince\Downloads\NexusAi\nexusai\frontend\src\components\pricing\PricingSection.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
