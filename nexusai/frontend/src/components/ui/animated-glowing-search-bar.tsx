  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="group relative flex items-center justify-center">
        <div className="absolute -z-10 h-full w-full max-h-[70px] max-w-[314px] overflow-hidden rounded-xl blur-[3px] before:absolute before:left-1/2 before:top-1/2 before:-z-20 before:h-[999px] before:w-[999px] before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-60 before:bg-[conic-gradient(#000,#402fb5_5%,#000_38%,#000_50%,#cf30aa_60%,#000_87%)] before:bg-no-repeat before:content-[''] before:transition-all before:duration-[2000ms] group-hover:before:-rotate-[120deg] group-focus-within:before:rotate-[420deg] group-focus-within:before:duration-[4000ms]" />
        <div className="absolute -z-10 h-full w-full max-h-[65px] max-w-[312px] overflow-hidden rounded-xl blur-[3px] before:absolute before:left-1/2 before:top-1/2 before:-z-20 before:h-[600px] before:w-[600px] before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[82deg] before:bg-[conic-gradient(rgba(0,0,0,0),#18116a,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#6e1b60,rgba(0,0,0,0)_60%)] before:bg-no-repeat before:content-[''] before:transition-all before:duration-[2000ms] group-hover:before:-rotate-[98deg] group-focus-within:before:rotate-[442deg] group-focus-within:before:duration-[4000ms]" />
        <div className="absolute -z-10 h-full w-full max-h-[63px] max-w-[307px] overflow-hidden rounded-lg blur-[2px] before:absolute before:left-1/2 before:top-1/2 before:-z-20 before:h-[600px] before:w-[600px] before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[83deg] before:bg-[conic-gradient(rgba(0,0,0,0)_0%,#a099d8,rgba(0,0,0,0)_8%,rgba(0,0,0,0)_50%,#dfa2da,rgba(0,0,0,0)_58%)] before:bg-no-repeat before:brightness-140 before:content-[''] before:transition-all before:duration-[2000ms] group-hover:before:-rotate-[97deg] group-focus-within:before:rotate-[443deg] group-focus-within:before:duration-[4000ms]" />
        <div className="absolute -z-10 h-full w-full max-h-[59px] max-w-[303px] overflow-hidden rounded-xl blur-[0.5px] before:absolute before:left-1/2 before:top-1/2 before:-z-20 before:h-[600px] before:w-[600px] before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[70deg] before:bg-[conic-gradient(#1c191c,#402fb5_5%,#1c191c_14%,#1c191c_50%,#cf30aa_60%,#1c191c_64%)] before:bg-no-repeat before:brightness-130 before:content-[''] before:transition-all before:duration-[2000ms] group-hover:before:-rotate-[110deg] group-focus-within:before:rotate-[430deg] group-focus-within:before:duration-[4000ms]" />

        <div id="main" className="relative group">
          <input
            placeholder="Search documents, sessions, or answers..."
            type="text"
            name="text"
          ...
          />
          <div className="absolute right-[7px] top-[7px] h-[42px] w-[40px] overflow-hidden rounded-lg before:absolute before:left-1/2 before:top-1/2 before:h-[600px] before:w-[600px] before:-translate-x-1/2 before:-translate-y-1/2 before:animate-spin before:rotate-90 before:bg-[conic-gradient(rgba(0,0,0,0),#3d3a4f,rgba(0,0,0,0)_50%,rgba(0,0,0,0)_50%,#3d3a4f,rgba(0,0,0,0)_100%)] before:bg-no-repeat before:brightness-135 before:content-['']" />
          <div
            id="filter-icon"
