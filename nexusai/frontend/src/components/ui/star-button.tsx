...
export function StarButton({
  ...
  return (
    <button
      ...
      ref={pathRef}
      className={cn(
        "group/star-button relative z-[3] inline-flex h-10 items-center justify-center gap-2 overflow-hidden rounded-3xl px-4 py-2 text-sm font-medium text-white transition-colors disabled:pointer-events-none disabled:opacity-50",
        className,
      )}
      {...props}
    >
      ...
      />
      <div
        className="absolute inset-0 z-[4] overflow-hidden rounded-[inherit] border border-black/10 text-white dark:border-[#F8F9FA]/15 dark:text-black"
